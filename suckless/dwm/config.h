...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray2, col_cyan, col_gray2 },
	[SchemeSel]  = { col_cyan, col_gray3,  col_gray4 },
};
